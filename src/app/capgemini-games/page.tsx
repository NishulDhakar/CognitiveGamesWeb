  ...
  return (
    ...
    <div className="hidden md:block px-4 pt-6 sm:pt-8">
        <button
          ...
          className="flex mt-4 ml-4 hover:bg-[#A35C2D]  items-center gap-3 rounded-lg border-2 border-black bg-zinc-100 px-4 py-2 text-base font-bold tracking-wide text-black shadow-[3px_3px_0px_0px_#000] transition-all duration-200  hover:text-white dark:border-white/20 dark:bg-zinc-900 dark:text-white dark:shadow-[3px_3px_0px_0px_#757373] dark:hover:bg-white dark:hover:text-black sm:px-6 sm:py-2 sm:text-lg"
        >
