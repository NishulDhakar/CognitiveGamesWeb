            ...
            <div className="container mx-auto max-w-7xl px-4 py-8 relative z-10">
                ...
                >
                    ...
                    <div className="flex items-center gap-2 bg-white/10 backdrop-blur-md px-4 py-2 rounded-full text-white/90 border border-white/20">
                        ...
                        <span className="text-sm font-medium">1,700+ Students Practicing</span>
                    </div>
                </motion.div>
                ...
                <div className="text-center mb-16 space-y-6">
                    ...
                    >
                        <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-white mb-6">
                            Capgemini Game-Based Aptitude Practice
                        </h1>
                    </motion.div>
                    ...
                    >
                        Challenge your mind with our suite of specialized cognitive games designed exactly like the real Capgemini and Cognizant placement assessments.
                    </motion.p>
                </div>
                ...
                >
                    <p className="text-sm text-muted-foreground flex items-center justify-center gap-2">
                        ...
                        <span className="text-white">Updated for 2025 Placement Season</span>
                    </p>
                </motion.div>
            </div>
        </div>
